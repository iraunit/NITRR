 ...
 * Use the [Department.newInstance] factory method to
 * create an instance of this fragment.
 */
class Department : Fragment() {
    private lateinit var recyclerviewwwww:RecyclerView
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    var recyclerView:RecyclerView?=null
    var layoutmanage=DepartmentData.listofDepartment
    var adapter:RecyclerView.Adapter<RecyclerView.ViewHolder>?=null
    var listofDept=ArrayList<DataModel>()
